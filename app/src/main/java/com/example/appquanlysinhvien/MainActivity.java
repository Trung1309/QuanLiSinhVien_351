...
public class MainActivity extends AppCompatActivity {
    ...
    public void CreateDataBase(){
        ...
        InsertSinhVienTable("2050531200351","Nguyen Quốc Trung", "3", "2002", 7, 8 ,9);
        InsertSinhVienTable("2050531200352","Nguyễn Văn B", "2", "2002", 8, 9 ,10);
        InsertSinhVienTable("2050531200353","Nguyễn Văn C", "2", "2002", 8, 9 ,10);
        InsertSinhVienTable("2050531200354","Nguyễn Văn D", "1", "2002", 7, 9 ,8);
        InsertSinhVienTable("2050531200355","Nguyễn Văn F", "3", "2002", 7, 8 ,10);
        InsertSinhVienTable("2050531200356","Nguyễn Văn F", "`", "2002", 7, 8 ,10);
        InsertSinhVienTable("2050531200357","Nguyễn Văn K", "3", "2002", 7, 8 ,10);
        InsertSinhVienTable("2050531200358","Nguyễn Văn L", "2", "2002", 7, 8 ,10);
        InsertSinhVienTable("2050531200359","Nguyễn Văn M", "3", "2002", 7, 8 ,10);
        InsertSinhVienTable("2050531200360","Nguyễn Văn N", "1", "2002", 7, 8 ,10);
    }
